...
| `app.js` | Bootstrap entry point — imports all modules, wires dependencies, delegates to module factories | ESM `script type="module"` tag |
...
- the left rail with Project, Compose, Score, Splits, Markers, Overlay, Review, Export, Settings, Metrics, and ShotML tools
...
- inspector panes for project metadata, scoring, timing, ShotML, Compose, overlays, markers, review text boxes, export controls, settings, and metrics
