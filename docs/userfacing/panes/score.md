...
| Shot card header | Selects the shot in the shared video/waveform context. |
| Shot card chevron | Expands or collapses that shot's score controls. |
...
4. Expand shot cards and choose the correct score value for each shot.
