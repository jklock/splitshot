...
Audit basis: current browser shell/backend wiring, the released `docs/v107` Phase 18 corrective closeout on `2026-07-07`, and the code-first pane function inventory generated by `scripts/audits/browser/pane_function_audit.py`.
