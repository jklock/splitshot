...
- this unnumbered `orchestration.prompt.md` file is the canonical prompt source for the Match lane
- `02-match-orchestration.prompt.md` is an archival alias and must not diverge
