...
name: "Stage Shell Reset Orchestrator"
...
- this unnumbered `orchestration.prompt.md` file is the canonical prompt source for the Stage lane
- `01-stage-orchestration.prompt.md` is an archival alias and must not diverge
