...
- this unnumbered `orchestration.prompt.md` file is the canonical prompt source for the Tests lane
- `06-tests-orchestration.prompt.md` is an archival alias and must not diverge
