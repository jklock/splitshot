...
name: "Performance Shell Reset Orchestrator"
...
- this unnumbered `orchestration.prompt.md` file is the canonical prompt source for the Performance lane
- `03-performance-orchestration.prompt.md` is an archival alias and must not diverge
