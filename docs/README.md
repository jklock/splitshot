...
SplitShot documentation is organized into three layers.

## Technical Docs

Technical documentation lives next to the source code it describes. Start with these package-level guides:
...
These describe the overall architecture, development workflow, and current limitations.
...
These are the GitHub-facing project files that round out the repo setup.
...
These explain how to use the application from import to export.
