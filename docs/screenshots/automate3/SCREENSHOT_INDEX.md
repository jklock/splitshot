...
| `responsive-proof-results.json` | Responsive Stage checks at 1280px and 900px | pass |
...
| File | Scenario | Size | Assertions |
| --- | --- | --- | --- |
| `responsive-stage-1280.png` | Stage with Project pane at 1280px | 599 KB | 1280×900 viewport, no overflow, rail visible, project pane visible |
| `responsive-stage-900.png` | Stage with Settings pane at 900px | 322 KB | 900×900 viewport, no overflow, rail visible, settings pane visible |
...
- Primary screenshot sets captured at 1440×900 viewport; responsive proof captured at 1280×900 and 900×900
...
- Machine proof does not replace normal release-governance review, but the Stage bundle now includes recorded visual notes for the responsive and pane captures.
